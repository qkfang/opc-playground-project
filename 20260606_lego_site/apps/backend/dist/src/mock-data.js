...
exports.defaultListings = exports.defaultSets = void 0;
exports.getSeedSetDocuments = getSeedSetDocuments;
exports.getSeedListingDocuments = getSeedListingDocuments;
exports.defaultSets = [
    {
        id: "10326",
...
function getSeedSetDocuments() {
    return exports.defaultSets.map((set) => ({ ...set, type: "set" }));
}
function getSeedListingDocuments() {
    return exports.defaultListings.map((listing) => ({ ...listing, type: "listing" }));
}
