const aboutCards = [
  {
    ...
    body: "A LEGO marketplace demo paired with a growing set of lightweight showcase pages. About3 is the latest of those simple, self-contained routes.",
  },
  {
...
const aboutFacts = [
  "About3 reuses the shared app shell and header navigation pattern",
...
export default function About3Page() {
  return (
    <section className="space-y-10">
      <div className="rounded-[2rem] bg-gradient-to-br from-indigo-900 via-violet-700 to-fuchsia-400 px-8 py-12 text-white shadow-lg">
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.28em] text-indigo-100">
          About This Site
        </p>
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">About3 Page</h1>
      ...
      <div className="grid gap-8 rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-indigo-100 md:grid-cols-[1.1fr_0.9fr]">
        <div>
        ...
        <aside className="rounded-3xl bg-indigo-50 p-6 ring-1 ring-indigo-100">
          <h3 className="text-lg font-semibold text-slate-900">About3 facts</h3>
      ...
      <div className="rounded-[2rem] border border-dashed border-fuchsia-300 bg-fuchsia-50 px-8 py-7">
