...
@description('Model deployment name for the prompt agents (triage / intent / task / outcome)')
...
@description('Storage blob container for the case journal / audit artefacts')
param containerName string = 'emailcases'
