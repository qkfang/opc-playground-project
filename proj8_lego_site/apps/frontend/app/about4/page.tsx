const aboutCards = [
  {
    ...
    body: "A LEGO marketplace demo paired with a growing set of lightweight showcase pages. About4 is the newest of those simple, self-contained routes.",
  },
  {
...
const aboutFacts = [
  "About4 reuses the shared app shell and header navigation pattern",
...
export default function About4Page() {
  return (
    <section className="space-y-10">
      <div className="rounded-[2rem] bg-gradient-to-br from-emerald-900 via-teal-700 to-cyan-400 px-8 py-12 text-white shadow-lg">
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.28em] text-emerald-100">
          About This Site
        </p>
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">About4 Page</h1>
      ...
      <div className="grid gap-8 rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-emerald-100 md:grid-cols-[1.1fr_0.9fr]">
        <div>
        ...
        <aside className="rounded-3xl bg-emerald-50 p-6 ring-1 ring-emerald-100">
          <h3 className="text-lg font-semibold text-slate-900">About4 facts</h3>
      ...
      <div className="rounded-[2rem] border border-dashed border-cyan-300 bg-cyan-50 px-8 py-7">
