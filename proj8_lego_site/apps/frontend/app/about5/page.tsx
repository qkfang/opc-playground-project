const aboutCards = [
  {
    ...
    body: "A LEGO marketplace demo paired with a growing set of lightweight showcase pages. About5 is the newest of those simple, self-contained routes.",
  },
  {
...
const aboutFacts = [
  "About5 reuses the shared app shell and header navigation pattern",
...
export default function About5Page() {
  return (
    <section className="space-y-10">
      <div className="rounded-[2rem] bg-gradient-to-br from-amber-900 via-orange-600 to-rose-400 px-8 py-12 text-white shadow-lg">
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.28em] text-amber-100">
          About This Site
        </p>
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">About5 Page</h1>
      ...
      <div className="grid gap-8 rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-amber-100 md:grid-cols-[1.1fr_0.9fr]">
        ...
        <aside className="rounded-3xl bg-amber-50 p-6 ring-1 ring-amber-100">
          <h3 className="text-lg font-semibold text-slate-900">About5 facts</h3>
      ...
      <div className="rounded-[2rem] border border-dashed border-rose-300 bg-rose-50 px-8 py-7">
