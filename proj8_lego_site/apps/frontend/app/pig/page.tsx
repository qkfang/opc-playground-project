const pigCards = [
  {
    title: "Curious and social",
    body: "Pigs are highly intelligent, social animals known for curiosity, adaptability, and surprisingly expressive behavior.",
  },
  {
    title: "Matches existing page style",
    body: "This page follows the same lightweight content layout already used by the other simple themed routes in the site.",
  },
  {
...
const pigFacts = [
  "Pigs are strong problem-solvers with good memory and awareness",
  "A dedicated route makes local render verification simple and obvious",
  "The page uses the shared app shell and header navigation pattern",
...
export default function PigPage() {
  return (
    <section className="space-y-10">
      <div className="rounded-[2rem] bg-gradient-to-br from-rose-800 via-pink-500 to-orange-300 px-8 py-12 text-white shadow-lg">
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.28em] text-rose-100">
          Animal Spotlight
        </p>
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Pig Page</h1>
        <p className="mt-4 max-w-2xl text-base leading-7 text-rose-50 sm:text-lg">
          A bright, friendly pig-themed page that fits the site&apos;s existing content
      ...
      <div className="grid gap-8 rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-rose-100 md:grid-cols-[1.1fr_0.9fr]">
        <div>
        ...
        <aside className="rounded-3xl bg-rose-50 p-6 ring-1 ring-rose-100">
          <h3 className="text-lg font-semibold text-slate-900">Pig facts</h3>
      ...
      <div className="rounded-[2rem] border border-dashed border-orange-300 bg-orange-50 px-8 py-7">
        <h2 className="text-2xl font-bold text-slate-900">Closing note</h2>
        <p className="mt-3 max-w-3xl leading-7 text-slate-700">
          A pig page should feel cheerful and uncomplicated: one clear route, one clear
