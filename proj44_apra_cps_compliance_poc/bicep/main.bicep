...
@description('Model deployment name for the compliance pipeline agents')
...
@description('Storage blob container for source documents / exported framework artifacts')
param containerName string = 'compliance'
