...
// Usage: node scripts/serve.mjs [port]   (default 4176), serves apps/web
...
const port = parseInt(process.argv[2] || "4176", 10);
...
server.listen(port, () => {
  console.log(`Cogsworth Robotics 2.0 dev server: http://127.0.0.1:${port}/`);
});
