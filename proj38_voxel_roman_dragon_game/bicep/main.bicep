// Infra for proj38 — Legions vs the Castle Dragon (voxel browser game)
// The game is a 100% client-side static site (HTML/CSS/JS ES modules + Three.js via CDN,
// no backend/API/DB and NO build step), so it deploys to a single
// Azure Static Web App (Free tier) in rg-playground-01.
targetScope = 'resourceGroup'

@description('Base name used to derive resource names (matches project_id).')
param baseName string = 'proj38'
