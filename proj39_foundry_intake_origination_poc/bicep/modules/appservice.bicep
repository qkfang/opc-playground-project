...
@description('SKU for the App Service plan (Standard tier per repo guideline)')
...
@description('Storage account name for origination cases / reports')
param storageAccountName string

@description('Storage container name')
param storageContainerName string

@description('Local data folder for durable case persistence on App Service')
...
resource webApp 'Microsoft.Web/sites@2023-12-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      ftpsState: 'Disabled'
      minTlsVersion: '1.2'
      appCommandLine: 'dotnet Proj39.IntakeOrigination.Web.dll'
      appSettings: [
        {
        ...
        }
        {
          ...
          value: 'proj39-intake-origination'
        }
        {
